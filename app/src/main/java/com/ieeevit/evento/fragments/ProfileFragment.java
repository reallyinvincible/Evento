...
public class ProfileFragment extends Fragment {
    ...
    private View setUserDetails(final LayoutInflater inflater, final ViewGroup container, final User user, final String qrString) {
        ...
        try {
            BitMatrix matrix = multiFormatWriter.encode(qrString, BarcodeFormat.QR_CODE, 500,500);
    ...
    private View setRegistrationDetails(LayoutInflater inflater, ViewGroup container, User user, boolean isCoordinator,final String qrString) {
